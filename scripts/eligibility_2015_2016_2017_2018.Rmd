...
###Joining eligibility 2015_2016_217 with eligibility 2018
...
#Race
ffs_mco_2015_2016_2017_2018$Overall_Race <- apply(ffs_mco_2015_2016_2017_2018[,grep("Race", names(ffs_mco_2015_2016_2017_2018))], 1, function(x){unique(na.omit(x))})
table(ffs_mco_2015_2016_2017_2018$Overall_Race, exclude = "ifany")
#                Black              Hispanic Native American/Asian                 Other                 White 
#                38945                   384                  1304                  6215                 57137 
...
ffs_mco_2015_2016_2017_2018$Overall_Citizen <- apply(ffs_mco_2015_2016_2017_2018[,grep("Citizen", names(ffs_mco_2015_2016_2017_2018))], 1, function(x){unique(na.omit(x))})
...
#Age at earliest enrollment
ffs_mco_2015_2016_2017_2018$Overall_Age_at_earliest_enrollment <- apply(ffs_mco_2015_2016_2017_2018[,grep("Age_at_earliest_enrollment", names(ffs_mco_2015_2016_2017_2018))], 1,function(x){min(na.omit(x))})
summary(ffs_mco_2015_2016_2017_2018$Overall_Age_at_earliest_enrollment)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  21.00   23.80   26.90   27.94   31.10   56.20 

#Region
ffs_mco_2015_2016_2017_2018$Overall_Region <- apply(ffs_mco_2015_2016_2017_2018[,grep("Region", names(ffs_mco_2015_2016_2017_2018))], 1, function(x){unique(na.omit(x))})
table(ffs_mco_2015_2016_2017_2018$Overall_Region, exclude = "ifany")
#                CENTRAL CHARLOTTESVILLE WESTERN   NORTHERN & WINCHESTER       ROANOKE/ALLEGHANY               SOUTHWEST               TIDEWATER 
#                  26039                   12725                   23834                   10452                    5973                   24962 
...
```{r}
medata <- ffs_mco_2015_2016_2017_2018[,grep(paste0(c("mco_beg1_2015",
                                                     "mco_beg2_2015",
                                                     "mco_beg3_2015",
                                                     "mco_beg4_2015",
                                                     "mco_end1_2015",
...
planEnrolled <- character()
nestedEnrolled <- character()
for(i in 1:nrow(medata)){
  ...
  if( (sum(is.na(mco_dat$X1))!=16) & (sum(is.na(ffs_dat$X1))!=16) ){
    ...
    for(j in 1:length(uniqueIntervals)){
      ...
      nestingTypes[j] <- ifelse((int_mco[1] <= int_ffs[1] & int_mco[2] <= int_ffs[2]), "mco in ffs", "ffs in mco")
      
      #case 1:no mco dates among those plan dates
      if(length(int_mco)==0){
        me_uniqueInts <- c(me_uniqueInts, as.numeric(floor((diff(int_ffs)+1)/30)))
      }
      #case 2:no ffs dates among those plan dates
      if(length(int_ffs)==0){
        me_uniqueInts <- c(me_uniqueInts, as.numeric(floor((diff(int_mco)+1)/30)))
      }
      #case 3:both mco and ffs dates among the plan stratum
      if(length(int_mco)!=0 & length(int_ffs)!=0){
        me_uniqueInts <- c(me_uniqueInts, as.numeric(floor((diff(int_ffs) + diff(int_mco) - Overlap(int_mco,int_ffs)+1)/30)))
      }
    }
    me <- sum(me_uniqueInts)
    nestingTypes <- unique(as.character(na.omit(nestingTypes)))
    if(length(nestingTypes)==1){
      nestedEnrolled[i] <- nestingTypes
    }else{nestedEnrolled[i] <- "mco in ffs AND ffs in mco"}
  }
  monthsEnrolled[i]<-me
  planEnrolled[i] <- plan
}

summary(monthsEnrolled)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  2.967   8.100  12.167  13.094  17.167  57.533 

length(which(monthsEnrolled<3))
#6

ffs_mco_2015_2016_2017_2018$months_enrolled <- monthsEnrolled
ffs_mco_2015_2016_2017_2018$planEnrolled <- planEnrolled
table(ffs_mco_2015_2016_2017_2018$planEnrolled, exclude = "ifelse")
# both   ffs   mco 
#81196 22661   128 
ffs_mco_2015_2016_2017_2018$nestedEnrolled <- nestedEnrolled
table(ffs_mco_2015_2016_2017_2018$nestedEnrolled, exclude = "ifany")
#               ffs in mco                mco in ffs mco in ffs AND ffs in mco                      none 
#                    35435                     29549                     16212                     22789 

table(ffs_mco_2015_2016_2017_2018$planEnrolled,ffs_mco_2015_2016_2017_2018$nestedEnrolled, exclude = "ifany")
#       ffs in mco mco in ffs mco in ffs AND ffs in mco  none
#  both      35435      29549                     16212     0
#  ffs           0          0                         0 22661
#  mco           0          0                         0   128
  
ffs_mco_2015_2016_2017_2018$months_enrolled_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 12, "9 - 12 mos", "> 12 mos"))))
ffs_mco_2015_2016_2017_2018$months_enrolled_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "> 12 mos"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_cat, exclude = "ifany")
#   < 3 mos  3 - 6 mos  7 - 9 mos 9 - 12 mos   > 12 mos 
#         6      12413      15456      20621      55489
```
-->
...
medata$me <- apply(medata, 1, myfunc)

ffs_mco_2015_2016_2017_2018$months_enrolled <- medata$me
summary(ffs_mco_2015_2016_2017_2018$months_enrolled)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   1.00    8.00   12.00   13.69   18.00   48.00 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   2.00    8.00   12.00   12.86   17.00   54.00 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
...
ffs_mco_2015_2016_2017_2018$months_enrolled_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled <= 12, "9 - 12 mos", "> 12 mos"))))
ffs_mco_2015_2016_2017_2018$months_enrolled_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "> 12 mos"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_cat)
#   < 3 mos  3 - 6 mos  7 - 9 mos 9 - 12 mos   > 12 mos 
#       304      17070      17283      31852      37476 
#   < 3 mos  3 - 6 mos  7 - 9 mos 9 - 12 mos   > 12 mos 
#       433      17374      18012      35890      32276 
#   < 3 mos  3 - 6 mos  7 - 9 mos 9 - 12 mos   > 12 mos 
#     23305      26601      25788      15629      12662 
       
ffs_mco_2015_2016_2017_2018 <- ffs_mco_2015_2016_2017_2018[-which(ffs_mco_2015_2016_2017_2018$months_enrolled_cat=="< 3 mos"),]
dim(ffs_mco_2015_2016_2017_2018)
#103460  
#103681
#103552 
...
```{r}
eligibility_2015 <- ffs_mco_2015_2016_2017_2018[which(ffs_mco_2015_2016_2017_2018$FY2015==1),]
...
medata_2015 <- eligibility_2015[,grep(paste0(c("mco_beg1_2015",
                                                    ...
                                                    #"ffs_end3_2015",
                                                    #"ffs_end4_2015"
                                               ), collapse = "|"), names(eligibility_2015))]
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   5.000   8.000   7.862  11.000  12.000 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   3.000   5.000   5.317   8.000  12.000 

ffs_mco_2015_2016_2017_2018$months_enrolled_2015 <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2015[which(ffs_mco_2015_2016_2017_2018$srecip %in% eligibility_2015$srecip)] <- eligibility_2015$months_enrolled_2015

ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2015 < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2015 >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled_2015 <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2015 > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled_2015 <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2015 > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled_2015 <= 12, "9 - 12 mos", NA))))
ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat[is.na(ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat)] <- "Not Eligible"
ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "Not Eligible"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_2015_cat)
#     < 3 mos    3 - 6 mos    7 - 9 mos   9 - 12 mos Not Eligible 
#        4651        12677         6984         3363        53005

le3me_srecip_2015 <- eligibility_2015$srecip[which(eligibility_2015$months_enrolled_2015<3)]

#ffs_mco_2015_2016_2017_2018 <- ffs_mco_2015_2016_2017_2018[-which(ffs_mco_2015_2016_2017_2018$srecip %in% le3me_srecip_2015),]
dim(ffs_mco_2015_2016_2017_2018)
#103371 
#103343
#80680   155
...
```{r}
eligibility_2016 <- ffs_mco_2015_2016_2017_2018[which(ffs_mco_2015_2016_2017_2018$FY2016==1),]
...
medata_2016 <- eligibility_2016[,grep(paste0(c("mco_beg1_2016",
                                                    ...
                                                    #"ffs_end3_2016",
                                                    #"ffs_end4_2016"
                                               ), collapse = "|"), names(eligibility_2016))]
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   6.000   9.000   8.523  12.000  12.000 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   3.000   6.000   5.713   8.000  12.000 

ffs_mco_2015_2016_2017_2018$months_enrolled_2016 <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2016[which(ffs_mco_2015_2016_2017_2018$srecip %in% eligibility_2016$srecip)] <- eligibility_2016$months_enrolled_2016

ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2016 < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2016 >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled_2016 <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2016 > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled_2016 <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2016 > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled_2016 <= 12, "9 - 12 mos", NA))))
ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat[is.na(ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat)] <- "Not Eligible"
ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "Not Eligible"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_2016_cat)
#     < 3 mos    3 - 6 mos    7 - 9 mos   9 - 12 mos Not Eligible 
#        5256        13007         8435         5076        48906 
        
le3me_srecip_2016 <- eligibility_2016$srecip[which(eligibility_2016$months_enrolled_2016<3)]

#ffs_mco_2015_2016_2017_2018 <- ffs_mco_2015_2016_2017_2018[-which(ffs_mco_2015_2016_2017_2018$srecip %in% le3me_srecip_2016),]
dim(ffs_mco_2015_2016_2017_2018)
#103309 
#103216
#80680   157
...
```{r}
eligibility_2017 <- ffs_mco_2015_2016_2017_2018[which(ffs_mco_2015_2016_2017_2018$FY2017==1),]
...
medata_2017 <- eligibility_2017[,grep(paste0(c("mco_beg1_2017",
                                                    ...
                                                    #"ffs_end3_2017",
                                                    #"ffs_end4_2017"
                                               ), collapse = "|"), names(eligibility_2017))]
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   6.000   9.000   8.721  12.000  12.000 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   3.000   6.000   5.823   9.000  12.000 

ffs_mco_2015_2016_2017_2018$months_enrolled_2017 <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2017[which(ffs_mco_2015_2016_2017_2018$srecip %in% eligibility_2017$srecip)] <- eligibility_2017$months_enrolled_2017

ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2017 < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2017 >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled_2017 <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2017 > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled_2017 <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2017 > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled_2017 <= 12, "9 - 12 mos", NA))))
ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat[is.na(ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat)] <- "Not Eligible"
ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "Not Eligible"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_2017_cat)
#     < 3 mos    3 - 6 mos    7 - 9 mos   9 - 12 mos Not Eligible 
#        5662        12403         7592         6419        48604 

le3me_srecip_2017 <- eligibility_2017$srecip[which(eligibility_2017$months_enrolled_2017<3)]

#ffs_mco_2015_2016_2017_2018 <- ffs_mco_2015_2016_2017_2018[-which(ffs_mco_2015_2016_2017_2018$srecip %in% le3me_srecip_2017),]
dim(ffs_mco_2015_2016_2017_2018)
#103227  
#103164
#80680   159
...
```{r}
eligibility_2018 <- ffs_mco_2015_2016_2017_2018[which(ffs_mco_2015_2016_2017_2018$FY2018==1),]
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   2.00    7.00   10.00    9.13   12.00   12.00 
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#      0       4       7       7      10      12 

ffs_mco_2015_2016_2017_2018$months_enrolled_2018 <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2018[which(ffs_mco_2015_2016_2017_2018$srecip %in% eligibility_2018$srecip)] <- eligibility_2018$months_enrolled_2018

ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat <- NA
ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat <- ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2018 < 3, "< 3 mos",
                                          ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2018 >= 3 & ffs_mco_2015_2016_2017_2018$months_enrolled_2018 <= 6, "3 - 6 mos",
                                                 ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2018 > 6 & ffs_mco_2015_2016_2017_2018$months_enrolled_2018 <= 9, "7 - 9 mos",
                                                        ifelse(ffs_mco_2015_2016_2017_2018$months_enrolled_2018 > 9 & ffs_mco_2015_2016_2017_2018$months_enrolled_2018 <= 12, "9 - 12 mos", NA))))
ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat[is.na(ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat)] <- "Not Eligible"
ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat <- factor(ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat, levels=c("< 3 mos", "3 - 6 mos", "7 - 9 mos", "9 - 12 mos", "Not Eligible"))
table(ffs_mco_2015_2016_2017_2018$months_enrolled_2018_cat)
#     < 3 mos    3 - 6 mos    7 - 9 mos   9 - 12 mos Not Eligible 
#        1924        11894         7748         8472        50642 

le3me_srecip_2018 <- eligibility_2018$srecip[which(eligibility_2018$months_enrolled_2018<3)]

#ffs_mco_2015_2016_2017_2018 <- ffs_mco_2015_2016_2017_2018[-which(ffs_mco_2015_2016_2017_2018$srecip %in% le3me_srecip_2018),]
dim(ffs_mco_2015_2016_2017_2018)
#103204 
#103153 
#80680   161
...
all_dfs$Overall_R_FIPS <- apply(all_dfs[,-1], 1, function(x){unique(na.omit(x))})
...
ffs_mco_2015_2016_2017_2018 <- dplyr::left_join(ffs_mco_2015_2016_2017_2018, all_dfs[,c(1,10,13,14)], by="srecip")
