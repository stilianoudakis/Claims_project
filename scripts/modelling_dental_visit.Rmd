...
# Creating date of earliest eligibility to calculate policy maturation variable

```{r}
DOEE <- apply(eligibility[,grep(paste0(c("ffs_beg","mco_beg"),collapse = "|"), names(eligibility))],1,function(x){min(na.omit(x))})

eligibility$policymaturation <- floor(as.numeric((as.Date(DOEE)-as.Date("2015-03-01"))/30))
eligibility$policymaturation[which(eligibility$policymaturation<0)] <- 0
```
...
model1 <- glm(dental_visit ~ months_enrolled +
                             policymaturation +
                             HPSA_status + 
                             Overall_Age_at_earliest_enrollment + 
                             Overall_Race + 
...
model2 <- glm(Preventive ~ months_enrolled +
                             policymaturation +
                             HPSA_status + 
                             Overall_Age_at_earliest_enrollment + 
                             Overall_Race + 
...
model3 <- glm(Treatment ~ months_enrolled +
                             policymaturation +
                             HPSA_status + 
                             Overall_Age_at_earliest_enrollment + 
                             Overall_Race + 
