...
model2 <- glm(Preventive ~ HPSA_status + 
                             Overall_Age_at_earliest_enrollment + 
                             Overall_Race + 
                             Overall_Citizen + 
                             Overall_Region + 
...
```{r}
mydata_final2$Treatment <- factor(ifelse(mydata_final2$Preventive=="Yes" & mydata_final2$Diagnostic==1, "Yes", "No"))

model3 <- glm(Treatment ~ HPSA_status + 
                             Overall_Age_at_earliest_enrollment + 
                             Overall_Race + 
                             Overall_Citizen + 
                             Overall_Region + 
