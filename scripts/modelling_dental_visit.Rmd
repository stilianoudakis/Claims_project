...
# Creating FY variables from claims data
...
mydata <- left_join(mydata, patient_level[, c("SRECIP", "FY2015_claims", "FY2016_claims", "FY2017_claims", "FY2018_claims")], by=c("srecip"="SRECIP"))
