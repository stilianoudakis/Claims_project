...
dental_visit_table <- cbind.data.frame(
  ...
  FY2015 = c(paste0(round(mean(mydata_final$Overall_Age_at_earliest_enrollment[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes")]),1), " ", "(", round(sd(mydata_final$Overall_Age_at_earliest_enrollment[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes")]),1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$Age_category=="under 30" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Age_category=="under 30" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Age_category=="over 30" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Age_category=="over 30" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$Overall_Race=="Black" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Race=="Black" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Race=="Other" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Race=="Other" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Race=="White" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Race=="White" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$HPSA_status=="No" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$HPSA_status=="No" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$HPSA_status=="Yes" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$HPSA_status=="Yes" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(round(mean(mydata_final$months_enrolled[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes")]),1), " ", "(", round(sd(mydata_final$months_enrolled[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes")]),1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$months_enrolled_cat=="3-10 months" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$months_enrolled_cat=="3-10 months" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$months_enrolled_cat==">10 months" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$months_enrolled_cat==">10 months" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$Overall_Citizen=="Non-US citizen" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Citizen=="Non-US citizen" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Citizen=="US (or naturalized) citizen" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Citizen=="US (or naturalized) citizen" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             "",
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="CENTRAL" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="CENTRAL" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="CHARLOTTESVILLE WESTERN" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="CHARLOTTESVILLE WESTERN" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="NORTHERN & WINCHESTER" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="NORTHERN & WINCHESTER" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="ROANOKE/ALLEGHANY" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="ROANOKE/ALLEGHANY" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="SOUTHWEST" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="SOUTHWEST" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")"),
             paste0(nrow(mydata_final[which(mydata_final$Overall_Region=="TIDEWATER" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), " ", "(", round(nrow(mydata_final[which(mydata_final$Overall_Region=="TIDEWATER" & mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])/nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),])*100,1),"%" ,")")),
...
names(dental_visit_table) <- c("Variable",
                              ...
                              paste0("Eligible in 2015 and had dental visit (N=", nrow(mydata_final[which(mydata_final$FY2015=="Yes" & mydata_final$dental_visit=="Yes"),]), ")"),
                              paste0("Eligible in 2016 and had dental visit (N=", nrow(mydata_final[which(mydata_final$FY2016=="Yes" & mydata_final$dental_visit=="Yes"),]), ")"),
                              paste0("Eligible in 2017 and had dental visit (N=", nrow(mydata_final[which(mydata_final$FY2017=="Yes" & mydata_final$dental_visit=="Yes"),]), ")"),
                              paste0("Eligible in 2018 and had dental visit (N=", nrow(mydata_final[which(mydata_final$FY2018=="Yes" & mydata_final$dental_visit=="Yes"),]), ")"))
```
