...
DOEE <- apply(mydata[,grep(paste0("mco_beg",collapse = "|"), names(mydata))],1,function(x){min(na.omit(x))})
...
#   0.00    0.00   11.00   13.32   24.00   37.00 
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   0.000   0.000   3.743   0.000  40.000 
